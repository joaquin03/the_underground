<?php
$array['pagetitle'] = 'User Content & Conduct Policy';
$array['pagedescription'] = '';
$page->page .= $page->get_temp('templates/legal/content.htm');
//// BREAD CRUMBS
$array['breadcrumbs'] .= $short->bcitem($rooturl.'/?mod=legal','Legal',2);
$array['breadcrumbs'] .= $short->bcitem($array['ogurl'],'User Content & Content Policy',3);
$array['extrameta'] .= '
