<?php
$array['pagetitle'] = 'Acceptable Use Policy';
$array['pagedescription'] = '';
$page->page .= $page->get_temp('templates/legal/acceptable_use_policy.htm');
//// BREAD CRUMBS
$array['breadcrumbs'] .= $short->bcitem($rooturl.'/?mod=legal','Legal',2);
$array['breadcrumbs'] .= $short->bcitem($array['ogurl'],'Acceptable Use Policy',3);
$array['extrameta'] .= '
