<?php
$array['pagetitle'] = 'Record Keeping Compliance';
$array['pagedescription'] = '';
$page->page .= $page->get_temp('templates/legal/record_keeping.htm');
//// BREAD CRUMBS
$array['breadcrumbs'] .= $short->bcitem($rooturl.'/?mod=legal','Legal',2);
$array['breadcrumbs'] .= $short->bcitem($array['ogurl'],'Record Keeping Compliance',3);
$array['extrameta'] .= '
