...
$pagename = 'local-sluts';
$array['leftcol'] = '';
$array['rightcol'] = '';
$canonical = $rooturl.'/?'.$pagename.'='.$_GET[''.$pagename.''];
...
$find_keyword = str_replace("'","",$location_full.' Sluts Slutty Whore Slut');



//// PAGE DETAILS
$array['pagetitle'] = 'Sluts for Sex in '.$location_full.' &middot; Local Pages';
$array['pagedescription'] = 'Find Local '.$location_suburb.' Sluts on the Underground Sex Club. A totally free site where you can contact local women for sex in '.$location_full.' for free.';
$array['title'] = 'Local '.$t['suburb'].' Sluts';
...
$array['breadcrumbs'] .= $short->bcitem($canonical,'Sluts in '.$location_suburb,5);


/// TOP PARAGRAPH
$array['leftcol'] .= '<h2>Find Sluts in '.$location_suburb.'</h2>
<p>Welcome to the Underground Sex Club '.$location_suburb.'.</p>
<p>We are a totally free site helping guys meet local sluts. We have all the information you need to find sluts in '.$location_suburb.' ('.$location_state.'). We are 100% free and have over 200 thousand members, plenty of them are womel looking for sex. AKA Sluts. We have been helping guys find slutty girls locally for over 10 years.</p>
<p>We have broken up our site into sections below, and have listed all of our local sluts near the top. We are one of the few totally free sites and we have no add ons or upgrades for sale. You will need to <a href="https://www.theundergroundsexclub.com/?mod=register">register</a> to contact the '.$location_suburb.' women below.</p>
<div class="space20"></div>
<a href="https://www.theundergroundsexclub.com/?sex=Female&from=From+Age&to=To+Age&sex_pref=Any&sex_relstatus=Any&country='.$location_country_full.'&keywords='.$t['url'].'&file=search&mod=members&button=Filter"><span class="button">View All '.$location_suburb.' Sluts &nbsp; &middot;&middot;></span></a>
<div class="space30"></div>';



///  MEMBERS
$array['leftcol'] .= '<h2>Sluts in '.$location_suburb.'</h2>
<p>Here are some of our local and nearby members. Most members below are from '.$location_suburb.', however, if we can\'t find enough sluts locally, we have included other women nearby that you may also be interested in meeting up with for sex. Just remember, it is free to contact any women on our site, you just need to be registered.</p>
<div class="space20"></div>';
...
<p>Lots of local women and sluts post in our forum, and it is a great place to start meeting slutty women in '.$location_suburb.'. Members in other '.$location_state.' areas also use of forum to meetup with girls. Here are some forums and discussions that might be useful for you.</p>
...
<p>Meeting sluts in '.$location_suburb.' might be easier if you join a local sex group. These groups are online groups and make it easy for you to meet likeminded people interested in sex.</p> <p>Here are some local sex groups that you might be interested in. Once again, if there aren\'t enough sex groups in '.$location_suburb.', we have included other popular groups that are nearby.</p>
<div class="space10"></div>
...
<h2>Member Posts</h2>
<p>Members of the Underground Sex Club '.$location_suburb.' are allowed to post messages directly to our site feed, and this can help locate local sluts for sex in your area. Here are some posts that have been made recently about '.$location_suburb.' sluts.</p>
<p>If you want to post a message directly to local women in the '.$location_suburb.' area, simply <a href="https://www.theundergroundsexclub.com/?mod=register">register</a> for a free account.</p>
<div class="space10"></div>
'.$feeds.'';
...
$prevtown = '<span class="onelinetext"><span class="red fstyle1 fs22 m0">&rsaquo;</span> &nbsp; <a href="'.$rooturl.'/?local-sluts='.$prev['url'].'">'.$prev['suburb'].' ('.$prev['state'].') Local Sluts</a></span>
';
...
$nexttown = '<span class="onelinetext"><span class="red fstyle1 fs22 m0">&rsaquo;</span> &nbsp; <a href="'.$rooturl.'/?local-sluts='.$next['url'].'">'.$next['suburb'].' ('.$next['state'].') Sluts</a></span>
';
