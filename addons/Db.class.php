...
class DB
{
	...
	*/
		...
		if(file_exists('./../configfile.php'))
			...
			try
			{
				...
				$this->pdo = new PDO($dsn, $dbuser, $dbpassword, array(PDO::MYSQL_ATTR_INIT_COMMAND => "SET NAMES utf8mb4"));
	...
	*	@return mixed
	*/
		public function query($query,$params = null, $fetchmode = PDO::FETCH_ASSOC,$countonly)
		{
			$query = trim($query);
